...
If a real database URL is ever committed or shared, rotate that database user's password immediately and replace the URL in Vercel environment variables.
